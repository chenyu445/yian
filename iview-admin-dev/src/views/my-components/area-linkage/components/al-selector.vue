        ...
        <Row :gutter="gutterNum">
            <Col :span="span" v-if="show(0)">
                <Select 
                    ...
                    transfer
                    style="width:100%">
                    <Option v-for="(item,index) in provList" :value="item" :key="item">{{ item }}</Option>
                </Select>
            </Col>
            ...
            <Col :span="span" v-if="show(2)">
                <Select 
                    ...
                    transfer
                    style="width:100%">
                    <Option v-for="(item,index) in counList" :value="item" :key="index">{{ item }}</Option>
                </Select>
            </Col>
            <Col :span="span" v-if="show(3)">
                <Select 
                    ...
                    transfer
                    style="width:100%">
                    <Option v-for="(item,index) in streList" :value="item" :key="index">{{ item }}</Option>
                </Select>
            </Col>
        </Row>
        <slot></slot>
